...
public class ViewHolder_Armoury extends RecyclerView.ViewHolder {
    ...
    public ViewHolder_Armoury(View itemView) {
        ...
        tacticalCalToolbar.inflateMenu(R.menu.player_set_equipment);
    }
}
