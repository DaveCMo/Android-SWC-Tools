...
public class AdaptorDelegate_TacticalCap {
    ...
    public AdaptorDelegate_TacticalCap(int viewType, Context context, ArrayList<Object> itemList) {
    ...
    public boolean isForViewType(ArrayList<Object> items, int position) {
        if (items.get(position) instanceof TacticalCapacityData) {
            ...
            if((tacticalCapacityData.getTYPE()==TacticalCapacityData.HERO)||(tacticalCapacityData.getTYPE()==TacticalCapacityData.STARSHIP)||(tacticalCapacityData.getTYPE()==TacticalCapacityData.TROOPTRANSPORT)){
                return true;
            }else return false;
        } else {
            return false;
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder tholder, final ArrayList<Object> itemList, final int position) {
        ...
        final ViewHolder_TacticalCapacity holder = (ViewHolder_TacticalCapacity) tholder;
...
//        holder.cap_List.addItemDecoration(new DividerItemDecoration(mContext, LinearLayoutManager.VERTICAL));
    ...
    private boolean setVisible(ViewHolder_TacticalCapacity holder, int position) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_player_tactical_capacity, parent, false);
        return new ViewHolder_TacticalCapacity(view);
    }
