...
public class MoveLayoutsFolders extends  Thread {
    ...
    public MoveLayoutsFolders(int folder, int newFolder, String search, boolean doFolders, Handler handler, Context context, ArrayList<Object> objects) {
        ...
        for (Object o : objects) {
            if (o instanceof LayoutRecord) {
                ...
                if (layoutRecord.isSelected()) {
                    LayoutHelper.updateLayoutFolder(layoutRecord.getLayoutId(), newFolder, context);
                }
            }
        }
