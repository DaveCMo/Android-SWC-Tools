...
public class WarRoomData_WarStatusModel implements Parcelable {
    ...
    public WarRoomData_WarStatusModel(Parcel in) {
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        public WarRoomData_WarStatusModel createFromParcel(Parcel in) {
            return new WarRoomData_WarStatusModel(in);
        }

        public WarRoomData_WarStatusModel[] newArray(int size) {
            return new WarRoomData_WarStatusModel[size];
        }
    };
    ...
    public WarRoomData_WarStatusModel(String playerId, Context context) {
