...
import com.swctools.activity_modules.layout_manager.views.ViewHolder_Layout_Selected;
...
public class AdaptorDelegate_LayoutRecord_Selected {
    ...
    public AdaptorDelegate_LayoutRecord_Selected(int viewType, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_card_selected, parent, false);
//        toolbar = (Toolbar) v.findViewById(R.id.layoutCard_Toolbar);
//        toolbar.inflateMenu(R.menu.layout_card_menu);
        return new ViewHolder_Layout_Selected(v);
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder tholder, ArrayList<Object> itemList, final int position) {
        ...
        final ViewHolder_Layout_Selected holder = (ViewHolder_Layout_Selected) tholder;
...
//        playerDetailsCapRecycler.addItemDecoration(new DividerItemDecoration(mContext, LinearLayoutManager.VERTICAL));
        ...
        holder.layoutCard_Layout.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                mInterface.layoutDeSelected(layoutContainer.getLayoutId(), position);
                return true;
            }
        });
