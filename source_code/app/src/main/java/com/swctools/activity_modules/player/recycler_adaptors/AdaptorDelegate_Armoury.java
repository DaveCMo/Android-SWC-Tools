...
import com.swctools.activity_modules.player.views.ViewHolder_Armoury;
...
public class AdaptorDelegate_Armoury {
    ...
    public AdaptorDelegate_Armoury(int viewType, Context context, ArrayList<Object> itemList) {
    ...
    public boolean isForViewType(ArrayList<Object> items, int position) {
        if (items.get(position) instanceof TacticalCapacityData) {
            ...
            if(tacticalCapacityData.getTYPE()==TacticalCapacityData.ARMOURY){
                return true;
            }else return false;
        } else {
            return false;
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder tholder, final ArrayList<Object> itemList, final int position) {
        ...
        final ViewHolder_Armoury holder = (ViewHolder_Armoury) tholder;
...
//        holder.cap_List.addItemDecoration(new DividerItemDecoration(mContext, LinearLayoutManager.VERTICAL));
        ...
        holder.tacticalCalToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if  (itemId == R.id.set_equipment_player) {
                    player_tacticalCallback.setEquipment();
                }
                return true;
            }
        });
    ...
    private boolean setVisible(ViewHolder_Armoury holder, int position) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        return new ViewHolder_Armoury(view);
    }
