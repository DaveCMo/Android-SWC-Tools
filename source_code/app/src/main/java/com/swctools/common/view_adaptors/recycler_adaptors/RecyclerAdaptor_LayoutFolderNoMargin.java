...
public class RecyclerAdaptor_LayoutFolderNoMargin extends RecyclerView.Adapter<ViewHolder_Folder> {
    ...
    public RecyclerAdaptor_LayoutFolderNoMargin(List<LayoutFolderItem> list, Context context) {
    ...
    public ViewHolder_Folder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_layout_folder_nomargin, parent, false);
