...
public class AdaptorDelegate_Spacer {
    private int viewType;
    private Context mContext;
    private int COLOR_RED;
    private int COLOR_GREEN;

    public AdaptorDelegate_Spacer(int viewType, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_spacer, parent, false);
