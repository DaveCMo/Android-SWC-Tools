...
import com.swctools.swc_server_interactions.swc_commands.Cmd_GuildPVPTroopsRequest;
import com.swctools.swc_server_interactions.swc_commands.Cmd_GuildWarTroopsRequest;
import com.swctools.util.MethodResult;

public class RequestPVPTroops extends SWC_Runnable_Base implements Runnable {
    private static final String TAG = "RequestPVPTroops";
    private String playerId;
    private String message;
    private boolean crystal;
    private Context context;

    public RequestPVPTroops(Handler swc_interaction_handler, String playerId, String message, boolean crystal, Context context) {
...
//        MethodResult methodResult = new MethodResult(false, "2320");
    ...
    private MethodResult processRequest() {
        ...
        try {
            SWCDefaultResponse swcDefaultResponse = new SWCMessage(playerLoginSession.getAuthKey(), true, playerLoginSession.getLoginTime(), new Cmd_GuildPVPTroopsRequest(playerLoginSession.newRequestId(), playerId, crystal, message), "Request War Troops", context).getSwcMessageResponse();
