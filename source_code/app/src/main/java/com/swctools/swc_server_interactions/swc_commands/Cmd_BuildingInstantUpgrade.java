...
public class Cmd_BuildingInstantUpgrade extends SWC_Command {
    private static final String TAG = "Cmd_BuildingInstantUpgr";
    private String playerId, buildingId;
    private int _credits, _materials, _contraband, _crystals;

    public Cmd_BuildingInstantUpgrade(int requestId, String playerId, String buildingId, long time){//}, int _credits, int _materials, int _contraband, int _crystals, long time) {
        super(requestId);
    ...
    protected void setAction() {
        this.action = "player.building.instantUpgrade";
    }
